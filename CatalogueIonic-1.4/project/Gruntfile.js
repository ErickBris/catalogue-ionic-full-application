			...
			development: {
				constants: {
					ENV: {
						...
						ionicAppId: 'eca7b2b5', //'2113c758',
						gcmId: '228071472080', // Google Developers Console
						// LOCAL or REMOTE or WOO_COMMERCE
						dataProvider: 'LOCAL',
						//
						// Uncomment the proper data section
						// according to the selected DATA provider
						//
						// LOCAL
						data: {
							apiUrl: 'misc/'
						...
						// REMOTE
						// data: {
						// 	apiUrl: 'http://skounis.s3.amazonaws.com/mobile-apps/'
						// }
						//
						// WOO_COMMERCE
						// data: {
						// 	apiUrl: 'https://demo.titaniumtemplates.com/wordpress/wc-api/v3/',
						// 	wooCommerceConsumerKey: 'ck_205e93038e16360912ae0b1fc2722bd4e0aab660',
						// 	wooCommerceConsumerSecret: 'cs_42ec5b3105231e8b87dc3115af3658bad159ccd4'
						// }
					}
				}
			},
