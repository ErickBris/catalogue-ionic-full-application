(function () {
	...
	function remoteDataService($http, $q, _, ENV) {
		var categoriesUrl = ENV.data.apiUrl + 'catalogue-demo/categories.json';
		var featuredProductsUrl = ENV.data.apiUrl + 'catalogue-demo/featured.json';
		var businessUrl = ENV.data.apiUrl + 'catalogue/business.json';
		var categories = [];
